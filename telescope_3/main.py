...
# --------------------------
# Global Theme Configuration (FIXED Input Widgets)
# --------------------------
THEMES = {
    "Dark (Default)": {
        "stylesheet": """
            ...
            /* Spin/DoubleSpin (Altitude/Azimuth/FPS) */
    ...
    "Astronomy Blue": {
        "stylesheet": """
            /* Global Theme: Astronomy Blue (FIXED Input Widgets) */
            QMainWindow { 
            ...
            QLineEdit {
                background-color: #112240;
                color: #e6f1ff; /* Light blue text on dark blue background */
                border: 1px solid #23395d;
                border-radius: 5px;
                padding: 5px;
            }
            QLineEdit:focus {
                border: 1px solid #ffd166; /* Highlight focus */
            }
            /* Spin/DoubleSpin (Altitude/Azimuth/FPS) */
            QSpinBox, QDoubleSpinBox {
                background-color: #112240;
...
class TelescopeMainWindow(QMainWindow):
    ...
    def _update_status_bar(self):
        """Update status bar with system info + GPIO status"""
