...
class DeepSeekWidget(QWidget):
    analyze_image = pyqtSignal(str)  # For webcam integration
    ...
    def update_telescope_context(self, current_alt, current_az, gps_str):
        ...
        self.telescope_context = {
            ...
            "azimuth": round(current_az, 1),
            "gps": gps_str
        }
        # Optional: Show context in status label for debugging/transparency
